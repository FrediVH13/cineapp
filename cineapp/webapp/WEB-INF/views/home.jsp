	...
	<main role="main">
		...
		<div class="container">
			<div class="my-3 p-3 bg-white rounded shadow-sm">
				<div class="row">
					<div class="col-sm-12">
						<h6 id="cartelera" class="border-bottom border-gray pb-2 mb-3">
									...
									<div class="row">
										<div class="col-sm-12">
											<a href="detail?idMovie=${movie.id}&date=${dateSelected}"
												...
												class="rounded w-100 border shadow" alt="${movie.title}"
												title="${movie.title}"></a>
										</div>
									</div>
									<button type="button"
										class="btn btn-outline-info btn-sm btn-block mt-1 rounded-bottom"
