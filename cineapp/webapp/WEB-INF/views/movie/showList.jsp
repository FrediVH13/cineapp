						...
						<tbody>
							<c:forEach items="${movies}" var="m">
								<tr>
									<td>
										<div class="media">
											<img src="${urlPublic}/images/movies/${m.billboardImage}"
											...
											<div class="media-body">
												...
												<br /> <span class="badge badge-secondary">${m.idClassification.classification}</span>
												<span class="badge badge-dark">${m.duration}</span> <span
													class="badge badge-info">${m.idGenre.genre}</span>
											</div>
										</div>
									</td>
