				...
				<form:form action="${save}" method="post" modelAttribute="movie"
						...
						<div class="col-md-9 col-lg-10">
							<div class="form-row">
								<div class="form-group col-md-10">
									<form:label path="billboardImage">Imagen de cartelera</form:label>
							...
							<div class="form-row">
								...
								<div class="form-group col-md-6">
									<form:label path="originalTitle">Título original <span
											class="text-danger">*</span>
									</form:label>
							...
							<div class="form-row">
								<div class="form-group col-md-6 col-lg-3">
									<form:label path="idGenre.genre">Género</form:label>
									<form:select path="idGenre.genre"
										cssClass="form-control form-control-sm">
										<form:option value="--" label="Selecciona un género"
											disabled="true" />
										<form:options items="${genreList}" itemLabel="genre"
											itemValue="id" />
									</form:select>
								</div>
								<div class="form-group col-md-6 col-lg-3">
									<form:label path="idClassification.classification">Clasificación</form:label>
									<form:select path="idClassification.classification"
										cssClass="form-control form-control-sm">
										<form:option value="--" label="Selecciona una clasificación"
											disabled="true" />
										<form:options items="${classificationList}"
											itemLabel="classification" itemValue="id" />
									</form:select>
								</div>
								<div class="form-group col-md-6 col-lg-3">
									<form:label path="releaseDate">Fecha de estreno</form:label>
									<form:input id="release_date" path="releaseDate"
							...
							<div class="form-row">
								<div class="form-group col-md-6">
									<form:label path="idDetailMovie.directors">Directores <span
											class="text-danger">*</span>
									</form:label>
									<form:input path="idDetailMovie.directors"
										cssClass="form-control form-control-sm" required="required" />
								</div>
								<div class="form-group col-md-6">
									<form:label path="idDetailMovie.actors">Actores <span
											class="text-danger">*</span>
									</form:label>
									<form:input path="idDetailMovie.actors"
										cssClass="form-control form-control-sm" required="required" />
								</div>
							</div>
							<div class="form-row">
								<div class="form-group col-md-12 col-lg-6">
									<form:label path="idDetailMovie.trailer">URL del Trailer <span
											class="text-danger">*</span>
									</form:label>
									<div class="input-group input-group-sm">
										<div class="input-group-prepend">
											<span class="input-group-text" id="trailer-url">https://youtube.com/embed/</span>
										</div>
										<form:input path="idDetailMovie.trailer" required="required"
											cssClass="form-control" aria-describedby="trailer-url" />
									</div>
								</div>
								<div class="form-group col-md-6 col-lg-3">
									<form:label path="idCountry.country">País de producción</form:label>
									<form:select path="idCountry.country" onchange='this.size=0;'
										onblur="this.size=0;"
					...
					<div class="form-row">
						<div class="form-group col-md-12">
							<form:label path="idDetailMovie.synopsis">Sinopsis <span
									class="text-danger">*</span>
							</form:label>
							<form:textarea rows="3" path="idDetailMovie.synopsis"
								required="required" cssClass="form-control form-control-sm" />
						</div>
					</div>
					<div class="row">
						<div class="form-group col-md-6">
